package com.shtukary.ita.config.swagger;
...
@Configuration
@EnableSwagger2
@ComponentScan(basePackages = "com.shtukary.ita.controller.profile")
public class SwaggerConfig {
    ...
    public Docket basicAuthSecuredApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.shtukary.ita.controller"))
